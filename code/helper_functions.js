...
//##################################################################################################################
// Run Survey - copied into a function from survey.js
//##################################################################################################################
function run_survey() {
    ...
    var surveyJSON = {
        "pages": [{
            ...
            "elements": [{
                ...
                "title": "Are you:",
                "isRequired": true,
                "choices": [{"value": "male", "text": "Male"}, {
                    "value": "female",
                    "text": "Female"
                }, {"value": "unspecified", "text": "Prefer not to say"}],
                "hasOther": true
            }, {
                "type": "radiogroup",
                ...
                }, {"value": "nativehawaiian", "text": "Native Hawaiian / Pacific Islander"}, {
                    "value": "unspecified",
                    "text": "Prefer not to say"
                }],
                "hasOther": true,
                "otherText": "Other or mixed (please specify)"
            }, {
                "type": "text",
                "name": "age",
